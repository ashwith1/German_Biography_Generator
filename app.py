...
I would like you to generate <700 biography of an interviewee based on the following questions in German language in paraghs that is autobiographical sketch and should be written in third-person., make sure it is in german language only. Please address each question thoroughly, ensuring that the narrative flows smoothly from one life stage to the next. The biography should include the following information:
...
def process_file_and_update_status(file):
    try:
        ...
        if transcript_data:
            ...
            remove_incomplete = summarizer.remove_incomplete_sentence(extend_biography)
...
if __name__ == '__main__':
>>>>>>> dfc4a891738bed885e36775a16b529abcda6834b
